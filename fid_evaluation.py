...
def setup_evaluation(dataset_name, generated_dir, target_size=128, num_imgs=8000, **metadata):
    ...
    if not os.path.exists(real_dir):
        ...
        # dataloader, CHANNELS = datasets.get_dataset(dataset_name, img_size=target_size, **metadata)
