...
if __name__ == '__main__':
    ...
    curriculum[
        'num_steps'] = curriculum[0]['num_steps'] * opt.ray_step_multiplier
    ...
    for seed in tqdm(opt.seeds):
        ...
        for i, yaw in enumerate(face_angles):
            ...
            img, tensor_img, depth_map = generate_img(generator, z,
                                                      **curriculum)
            images.append(tensor_img)
        save_image(torch.cat(images),
                   os.path.join(opt.output_dir, f'grid_{seed}.png'),
                   normalize=True)
